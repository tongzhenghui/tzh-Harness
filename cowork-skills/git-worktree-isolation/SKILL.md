...
description: "Use when starting feature work that needs isolation from current workspace, before executing implementation plans, or when dispatching parallel agents that each need their own working directory - creates isolated git worktrees with smart directory selection and safety verification."
---
